...
<div className="top-articles-container">
  <h2 className="article">Top Articles</h2>
      <div className="top-articles1-card">
  <div className="top-articles1-links">


    <a href="/buy-now-pay-later" className="top-articles1-link">
      Pay over time with Buy Now, Pay Later
    </a>

    <a href="/verified-buyer" className="top-articles1-link">
      How to become a Verified Buyer
    </a>

    <a href="/bidding-before-auction" className="top-articles1-link">
      Bidding on an Item Before It Goes Up For Auction
    </a>

    <a href="/buyer-protection" className="top-articles1-link">
      WhatNew Buyer Protection Policy
    </a>

    <a href="/cancel-order" className="top-articles1-link">
      Cancel your order
    </a>
