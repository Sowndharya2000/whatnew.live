...
<div className="section-box1">
  <h2 className="section-title1">Manage Your Account</h2>

  <div className="section-cards1">
    <div className="section-links1">

      <a href="/mobile-notifications" className="section-link1">
        Setting up your Mobile App Notification Settings
      </a>

      <a href="/update-email-password" className="section-link1">
        Update your Email and Password – Self Service
      </a>

      <a href="/multiple-accounts" className="section-link1">
        Managing Multiple Accounts on WhatNew
      </a>

      <a href="/deleting-form" className="section-link1">
        WhatNew Deleting Form
      </a>

      <a href="/support-system" className="section-link1">
